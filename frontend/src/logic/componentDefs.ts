...
export const COMPONENT_DEFS: Record<string, CompDef> = {
    ...
    MCU_ESP32: {
        tag: 'board-esp32-devkit-c-v4', renderW: 240, renderH: 260,
        compType: 'mcu', isFritzing: false,
        pins: [
            { id: '3V3',      xPct: 0.15, yPct: 0.10, color: C.VCC },
            { id: 'GND',      xPct: 0.15, yPct: 0.75, color: C.GND },
            { id: '5V',       xPct: 0.85, yPct: 0.10, color: C.VCC },
            { id: 'GND.2',    xPct: 0.85, yPct: 0.15, color: C.GND },
            { id: 'GPIO21',   xPct: 0.85, yPct: 0.40, color: C.SIGNAL },
            { id: 'GPIO22',   xPct: 0.85, yPct: 0.25, color: C.SIGNAL },
        ],
    },
